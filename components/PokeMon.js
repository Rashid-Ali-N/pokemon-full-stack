...
// heart button on inventory list, function will be taking "useState" and create a new instance of state in the favorites list route. 
    ...
    <div>
      ...
      <div className="body-2">
        <img
          ...
          width="200"
        />
        <button onClick={() => this.props.addFavorite(user)}> Favorite Pokemon!</button>
